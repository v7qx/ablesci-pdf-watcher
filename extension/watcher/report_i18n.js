...
(function () {
  ...
  const REASON_TRANSLATIONS = {
    ...
    'publisher_daily_limit': 'ScienceDirect 已达到当日下载上限',
    'publisher_daily_limit_stopped': 'ScienceDirect 当日通道已暂停',
    'publisher_daily_limit_resume': '等待 ScienceDirect 次日自动恢复',
    'publisher_counter_unavailable': 'ScienceDirect 下载计数暂时不可用，仅停止当前任务',
    'not_due': '时间未到',
    'no_cookie': '未检测到有效凭证',
  ...
  const REASON_TRANSLATIONS_EN = {
    ...
    'publisher_daily_limit': 'ScienceDirect daily download limit reached',
    'publisher_daily_limit_stopped': 'ScienceDirect publisher lane paused for the day',
    'publisher_daily_limit_resume': 'Waiting for ScienceDirect daily reset',
    'publisher_counter_unavailable': 'ScienceDirect download counter temporarily unavailable; current task stopped only',
    'not_due': 'Not due yet',
